...
public enum Action
{
    ...
    */
    ...
    // PushNS("Push(N,N)", ActionType.Push, -1, 0, 1, 0),
    ...
    // PushES("Push(E,N)", ActionType.Push, 0, 1, 1, 0),
    ...
    // PullNS("Pull(N,N)", ActionType.Pull, -1, 0, 1, 0),
    ...
    // PullES("Pull(E,N)", ActionType.Pull, 0, 1, 1, 0),
